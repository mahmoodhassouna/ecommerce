                            ...
                            <div id="megamenu" class="nov-megamenu clearfix">
                                <ul class="menu level1">
                                    <li class="item home-page has-sub"><span class="opener"></span><a
                                            href="{{route('home')}}" title="Home"><i class="zmdi zmdi-home"></i>Home</a>
                                        <div class="dropdown-menu" style="width:200px">

                                        </div>
                                    </li>
                                    <li class="item  has-sub"><span class="opener"></span><a href="{{route('user.contact')}}" title="Contact us">Contact us</a>

                                    </li>
                                    <li class="item menu-page group"><span class="opener"></span><a
                                            href="{{route('user.about')}}" title="Pages"><i
                                                class="zmdi zmdi-assignment"></i>About Us</a>
